...
public class MovieOld implements Parcelable, Constants {
   ...
   // public static final int NUM_CAST_DISPLAY = 3;
    ...
    public static final Parcelable.Creator<MovieOld> CREATOR = new Parcelable.Creator<MovieOld>() {
        @Override
        public MovieOld createFromParcel(Parcel in) {
            return new MovieOld(in);
        }

        @Override
        public MovieOld[] newArray(int size) {
            return new MovieOld[size];
        }
    };
}