...
public class SearchableActivity extends AppCompatActivity implements Constants {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.fourthwardmobile.android.movingpictures.R.layout.activity_searchable);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            toolbar.setNavigationIcon(getResources().getDrawable(com.fourthwardmobile.android.movingpictures.R.drawable.ic_arrow_back_white, null));
        ...
        setTitle(getString(com.fourthwardmobile.android.movingpictures.R.string.search_results));
        Log.e(TAG,"onCreate()");
