 ...
 * Created: 7/25/2015
 * <p/>
 * Main Activity of the MovingPictures App
 */
public class MainActivity extends AppCompatActivity implements MainFragment.Callback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.fourthwardmobile.android.movingpictures.R.layout.activity_main);
        ...
        DrawerLayout drawer = (DrawerLayout) findViewById(com.fourthwardmobile.android.movingpictures.R.id.drawer_layout);
        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(
                this, drawer, toolbar, com.fourthwardmobile.android.movingpictures.R.string.navigation_drawer_open, com.fourthwardmobile.android.movingpictures.R.string.navigation_drawer_close);
        drawer.setDrawerListener(toggle);
        toggle.syncState();

        NavigationView navigationView = (NavigationView) findViewById(com.fourthwardmobile.android.movingpictures.R.id.nav_view);
...
//                        + mMovieNowPlayingId + ", upUd = " + mMovieUpcomingId);
        ...
        if ((findViewById(com.fourthwardmobile.android.movingpictures.R.id.movie_detail_container) != null)) {
            ...
            if (savedInstanceState == null) {
                getSupportFragmentManager().beginTransaction()
                        .replace(com.fourthwardmobile.android.movingpictures.R.id.movie_detail_container, new MovieDetailFragment(),
                                DETAILFRAGMENT_TAG)
                        .commit();
            }
        } else {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(com.fourthwardmobile.android.movingpictures.R.menu.menu_search, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == com.fourthwardmobile.android.movingpictures.R.id.action_settings) {
            return true;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == com.fourthwardmobile.android.movingpictures.R.id.nav_movies) {
            mEntType = ENT_TYPE_MOVIE;
        } else if (id == com.fourthwardmobile.android.movingpictures.R.id.nav_tv_shows) {
            mEntType = ENT_TYPE_TV;
        } else if (id == com.fourthwardmobile.android.movingpictures.R.id.nav_people) {
    ...
    public void onItemSelected(@EntertainmentType int entType,int id, ImageView imageView) {
        ...
        if (mTwoPane) {
            ...
            getSupportFragmentManager().beginTransaction()
                    .replace(com.fourthwardmobile.android.movingpictures.R.id.movie_detail_container, fragment, DETAILFRAGMENT_TAG)
                    .commit();
        } else {
            Intent intent = null;
            ...
            if(intent != null) {
                ...
                ActivityOptionsCompat activityOptions =
                        ActivityOptionsCompat.makeSceneTransitionAnimation(this,
                                new Pair<View, String>(imageView, getString(com.fourthwardmobile.android.movingpictures.R.string.trans_poster)));
...
//             + mFavoriteTvId + ", personId = " + mFavoritPeopleId);
    ...
    private void setPagerForSelection() {
        ...
        //Create Tab layout
        mTabLayout = (TabLayout) findViewById(com.fourthwardmobile.android.movingpictures.R.id.tab_layout);

        mTabLayout.removeAllTabs();
        if (mEntType == ENT_TYPE_MOVIE) {
            //Set title of activity
            setTitle(com.fourthwardmobile.android.movingpictures.R.string.title_movies);

            mTabLayout.addTab(mTabLayout.newTab()
                    .setText(getString(com.fourthwardmobile.android.movingpictures.R.string.tab_popular)));
            mTabLayout.addTab(mTabLayout.newTab()
                    .setText(getString(com.fourthwardmobile.android.movingpictures.R.string.tab_now_playing)));
            mTabLayout.addTab(mTabLayout.newTab()
                    .setText(getString(com.fourthwardmobile.android.movingpictures.R.string.tab_upcoming)));

        } else if (mEntType == ENT_TYPE_TV) {
            //Set title of activity
            setTitle(com.fourthwardmobile.android.movingpictures.R.string.title_tv_shows);

            mTabLayout.addTab(mTabLayout.newTab()
                    .setText(getString(com.fourthwardmobile.android.movingpictures.R.string.tab_popular)));
            mTabLayout.addTab(mTabLayout.newTab()
                    .setText(getString(com.fourthwardmobile.android.movingpictures.R.string.tab_airing_tonight)));
        } else if (mEntType == ENT_TYPE_PERSON) {
            //Set title of activity
            setTitle(com.fourthwardmobile.android.movingpictures.R.string.title_people);

            mTabLayout.addTab(mTabLayout.newTab()
                    .setText(getString(com.fourthwardmobile.android.movingpictures.R.string.tab_popular)));
        } else if(mEntType == ENT_TYPE_FAVORITE) {
            //Set title of activity
            setTitle(com.fourthwardmobile.android.movingpictures.R.string.title_favorites);

            mTabLayout.addTab(mTabLayout.newTab()
                    .setText(getString(com.fourthwardmobile.android.movingpictures.R.string.tab_movies)));
            mTabLayout.addTab(mTabLayout.newTab()
                    .setText(getString(com.fourthwardmobile.android.movingpictures.R.string.tab_tv_shows)));
            mTabLayout.addTab(mTabLayout.newTab()
                    .setText(getString(com.fourthwardmobile.android.movingpictures.R.string.tab_people)));
        }

        //Create view pager for tabs
        mViewPager = (ViewPager)findViewById(com.fourthwardmobile.android.movingpictures.R.id.pager);
