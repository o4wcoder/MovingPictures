...
public class ShowAllListAdapter extends RecyclerView.Adapter<ShowAllListAdapter.CreditListAdapterViewHolder>
    ...
    public CreditListAdapterViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(mContext).inflate(com.fourthwardmobile.android.movingpictures.R.layout.image_name_character_list_item,parent,false);
    ...
    public class CreditListAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public CreditListAdapterViewHolder(View view) {
            ...
            thumbImageView = (ImageView)view.findViewById(com.fourthwardmobile.android.movingpictures.R.id.posterImageView);
            titleTextView = (TextView)view.findViewById(com.fourthwardmobile.android.movingpictures.R.id.titleTextView);
            characterTextView = (TextView)view.findViewById(com.fourthwardmobile.android.movingpictures.R.id.characterTextView);
        }
